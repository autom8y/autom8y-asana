...
telos:
  ...
  shipped_definition:
    code_or_artifact_landed:
      ...
      - "(landed S8-0 2026-07-30, PR #292 6ba2a04f) pre-gate hardening — tests/harness/substrate_gate/{parity.py (AIMD slot.reject on 429, mutation-proven), budget.py (per-day P10 counter, ParityBudgetExhausted, singleton fetcher), exemplars.py (exemplar #2 current-state anchor $80,985, S3-derived 0-Asana, drift −$3,400/−4.03% vs frozen $84,385)} + bytes-vs-constant tripwire test + .ledge/reviews/RECEIPT-s8-0-fixture-recapture-2026-07-30.md + UV-P-6 minted (.ledge/decisions/UV-P-6-real-section-counts-2026-07-30.md) + DEFER-2026-052..055 promoted to .sos/wip/defer-watch/; qa-adversary GO (285 green, 24 CI checks); ZERO src/substrate changes (seams held)"
      - "(landed S8-1 2026-07-30) fixture-replay GATE RECEIPT PASS — .ledge/reviews/GATE-substrate-v2-s8-1-fixture-replay-2026-07-30.md:1 (22/22 predicates + both exemplars, 285/285 on main 6ba2a04f content, self-discrimination 5/5, unexplained divergences 0; the deterministic HALF of LEG-1 — live-parity half remains)"
      - "(DISCHARGED 2026-07-30, operator grant in-channel) DP-4a APPLIED — PROV-1..6 live in CloudWatch (plan 6/0/0, saved-plan apply, ticket-mode; ratification record .ledge/decisions/DP-4a-READY-provability-alarms-apply-2026-07-30.md §Ratification) + PROV-2 dead-man FIRED on heartbeat absence as predicted (C10 fires-side evidence banked; clears at first parity sweep) + C8 RULED option-c/table/ack (.ledge/decisions/C8-sla-governance-packet-2026-07-30.md §Ratification, grant-interpretation disclosed) → architect C17 DELTA (TDD §11) → PR #295 MERGED 86aeb0d3 (governed freshness_sla_seconds, six entities 3600s, cache-TTL untouched/P6 witness test, qa-adversary GO + F1 mutant-killer folded) — BOTH S8-2 gates OPEN"
      - "(planned) S8-2 bounded live-parity window + PT-03 (LEG-1 completion), PT-04 >=2 warm cycles (LEG-2), S11 v1-extinction (LEG-3), S9 doctrine LANDING + S10 kit (LEG-4), S12 eunomia attestation (P12 epoch exit) — S8 state-of-record at .ledge/handoffs/HANDOFF-s8-0-complete-awaiting-operator-2026-07-30.md"
