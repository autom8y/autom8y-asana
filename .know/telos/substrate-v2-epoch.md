...
telos:
  ...
  shipped_definition:
    code_or_artifact_landed:
      ...
      - "(staged for operator 2026-07-30) DP-4a-READY terraform packet (.ledge/decisions/DP-4a-READY-provability-alarms-apply-2026-07-30.md — PROV-1..6 incl. D6b/PROV-6; PROV-2 fires-on-apply expectation documented) + C8 SLA-governance packet (.ledge/decisions/C8-sla-governance-packet-2026-07-30.md — 180s offer SLA vs ~20min warm cadence would starve parity; option-c recommended) — BOTH gate S8-2 arming"
