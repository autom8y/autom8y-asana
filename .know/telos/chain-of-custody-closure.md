...
telos:
  ...
  attestation_status:
    ...
    verified_realized: ATTESTED-WITH-FLAG (PARTIAL — items (i)+(iii) only)  # PARTIAL, 2026-08-14, eunomia verification-auditor (rite-disjoint, co-seated). ATTESTED on items (i) and (iii) ONLY, and ONLY on evidence the attester re-derived own-hands: (i) two-sided swap-detector demonstration — count-preserving swap -> NOT_OBSERVABLE/content_hash_mismatch, honest delivery -> OBSERVABLE, module contract ruled MATCHING its implementation (no over-claiming docstring survives); (iii) gate proven BITING red-then-green by the attester's OWN synthetic canary (RED failure + mergeStateStatus BLOCKED at 665d459f, PR #374 retired unmerged and branch deleted; GREEN success re-observed at c71c5c87 and f1dd14e7). FLAG on item (ii): the ratified-design rung is NOT reached — conjunct A (ratified design) is satisfied by R-7, conjunct B (named owner) is NOT, because the owner named is a security bench the same ruling records as never materialized (RULINGS-coc-phase2-operator-sitting-2026-08-14.md:44-46). The (ii) rung call, the F-2 rotation act and RE-1 ownership remain OPERATOR-ONLY. See VERDICT-cc8-partial-attest-2026-08-14.md §6.
    last_eunomia_advisory: ".ledge/reviews/VERDICT-cc8-partial-attest-2026-08-14.md:1"  # FLAG-ADVISORY (product-altitude, non-blocking). Carries a NO-CRITIC DISCLOSURE: CC-8's ratified critic (compliance-architect/security) was NOT seated for this attest.
  receipt_grammar:
    per_item_file_line_anchors:
      ...
      - "verified_realized item (ii): .ledge/decisions/RULINGS-coc-phase2-operator-sitting-2026-08-14.md:44-46 — FLAG, rung NOT reached. The cited text verbatim RECORDS that the named owner (a security bench) never materialized, so conjunct B of 'a ratified design with a named owner' is unsatisfied. VERDICT-cc8-partial-attest-2026-08-14.md §6"
