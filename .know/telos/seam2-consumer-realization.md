...
telos:
  ...
  verified_realized_definition:
    ...
    verification_deadline: "2026-07-03"  # OPERATOR-RATIFIED 2026-06-12 (interview R3-Q2: realization-bound = clear+14d; clear co-signed 2026-06-19T09:02:05Z → 07-03). DEADLINE-MISSED: as of 2026-07-07 (A1 reconcile) this date is 4 days past with nothing landed on main. Disposition = RULED-DEFER 2026-07-07 (B1 probe ran; ADR-seam2-disposition-b1-2026-07-07.md + defer-watch seam2-fork-disposition status RULED-DEFER-2026-07-07). RETIRE REFUTED — operator-plane offer_level_stats emits ad-performance only, NOT offer sale-revenue; it does NOT obviate the rebind. BUILD is the standing lean but BLOCKED on T1 (payments→offer attribution ruling absent) + T2 (ACTIVE registry empty → ACTIVE-62 denominator uncomputable). shipped stays MISSING (DEFER is a disposition, not a landing). DO NOT silently re-date.
