...
# egress guard. It is NOT "no mailbox at all" -- the v3 template pointer deliberately
...
_BODY_TEMPLATE = (
    ...
    "approved rep email template (rep-onboarding-deck-email-template-v3-2026-07-07.md; "
