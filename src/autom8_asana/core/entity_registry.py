...
ENTITY_DESCRIPTORS: tuple[EntityDescriptor, ...] = (
    ...
    # Per ADR-pipeline-stage-aggregation: Each pipeline project is registered
    # as a separate warmable entity sharing the same ProcessSchema,
    # ProcessExtractor, and ProcessRow. The discriminator (pipeline_type)
    # is set by the Phase 2 aggregator, not by the extractor.
    # warm_priority 10-18: after existing entities (1-6), before aggregation.
    # =========================================================================
    EntityDescriptor(
        name="process_sales",
        pascal_name="ProcessSales",
        display_name="Sales Pipeline",
        category=EntityCategory.LEAF,
        primary_project_gid=SALES_PIPELINE_PROJECT,
        warmable=True,
        warm_priority=10,
        key_columns=("office_phone", "vertical"),
        schema_module_path="autom8_asana.dataframes.schemas.process.PROCESS_SCHEMA",
        extractor_class_path="autom8_asana.dataframes.extractors.process.ProcessExtractor",
        row_model_class_path="autom8_asana.dataframes.models.task_row.ProcessRow",
        custom_field_resolver_class_path="autom8_asana.dataframes.resolver.DefaultCustomFieldResolver",
    ),
    EntityDescriptor(
        name="process_outreach",
        pascal_name="ProcessOutreach",
        display_name="Outreach Pipeline",
        category=EntityCategory.LEAF,
        primary_project_gid=OUTREACH_PIPELINE_PROJECT,
        warmable=True,
        warm_priority=11,
        key_columns=("office_phone", "vertical"),
        schema_module_path="autom8_asana.dataframes.schemas.process.PROCESS_SCHEMA",
    ...
    EntityDescriptor(
        ...
        pascal_name="ProcessOnboarding",
        display_name="Onboarding Pipeline",
        category=EntityCategory.LEAF,
        primary_project_gid=ONBOARDING_PIPELINE_PROJECT,
        warmable=True,
        warm_priority=12,
        key_columns=("office_phone", "vertical"),
        schema_module_path="autom8_asana.dataframes.schemas.process.PROCESS_SCHEMA",
    ...
    EntityDescriptor(
        ...
        pascal_name="ProcessImplementation",
        display_name="Implementation Pipeline",
        category=EntityCategory.LEAF,
        primary_project_gid=IMPLEMENTATION_PIPELINE_PROJECT,
        warmable=True,
        warm_priority=13,
        key_columns=("office_phone", "vertical"),
        schema_module_path="autom8_asana.dataframes.schemas.process.PROCESS_SCHEMA",
    ...
    EntityDescriptor(
        name="process_month1",
        pascal_name="ProcessMonth1",
        display_name="Activation Consultation Pipeline",
        category=EntityCategory.LEAF,
        primary_project_gid=ACTIVATION_CONSULTATION_PROJECT,
        warmable=True,
        warm_priority=14,
        key_columns=("office_phone", "vertical"),
        schema_module_path="autom8_asana.dataframes.schemas.process.PROCESS_SCHEMA",
    ...
    EntityDescriptor(
        name="process_retention",
        pascal_name="ProcessRetention",
        display_name="Retention Pipeline",
        category=EntityCategory.LEAF,
        primary_project_gid=RETENTION_PIPELINE_PROJECT,
        warmable=True,
        warm_priority=15,
        key_columns=("office_phone", "vertical"),
        schema_module_path="autom8_asana.dataframes.schemas.process.PROCESS_SCHEMA",
    ...
    EntityDescriptor(
        name="process_reactivation",
        pascal_name="ProcessReactivation",
        display_name="Reactivation Pipeline",
        category=EntityCategory.LEAF,
        primary_project_gid=REACTIVATION_PIPELINE_PROJECT,
        warmable=True,
        warm_priority=16,
        key_columns=("office_phone", "vertical"),
        schema_module_path="autom8_asana.dataframes.schemas.process.PROCESS_SCHEMA",
    ...
    EntityDescriptor(
        name="process_account_error",
        pascal_name="ProcessAccountError",
        display_name="Account Error Pipeline",
        category=EntityCategory.LEAF,
        primary_project_gid=ACCOUNT_ERROR_PIPELINE_PROJECT,
        warmable=True,
        warm_priority=17,
        key_columns=("office_phone", "vertical"),
        schema_module_path="autom8_asana.dataframes.schemas.process.PROCESS_SCHEMA",
    ...
    EntityDescriptor(
        ...
        pascal_name="ProcessExpansion",
        display_name="Expansion Pipeline",
        category=EntityCategory.LEAF,
        primary_project_gid=EXPANSION_PIPELINE_PROJECT,
        warmable=True,
        warm_priority=18,
        key_columns=("office_phone", "vertical"),
        schema_module_path="autom8_asana.dataframes.schemas.process.PROCESS_SCHEMA",
