...
DATA_SERVICE_ENTITIES: dict[str, DataServiceEntityInfo] = {
    ...
    # --- Remaining factories (Phase 5 completion) ---
    "account": DataServiceEntityInfo(
        factory="account",
        frame_type="business",
    ...
    "ads": DataServiceEntityInfo(
        factory="ads",
        frame_type="offer",
        description="Individual ad performance metrics",
        columns=[
            "office_phone",
            "vertical",
            "spend",
    ...
    "adsets": DataServiceEntityInfo(
        factory="adsets",
        frame_type="offer",
        description="Ad set level metrics",
        columns=[
            "office_phone",
            "vertical",
            "spend",
    ...
    "targeting": DataServiceEntityInfo(
        factory="targeting",
        frame_type="offer",
        description="Audience targeting metrics",
        columns=[
            "office_phone",
            "vertical",
            "spend",
    ...
    "payments": DataServiceEntityInfo(
        factory="payments",
        frame_type="business",
    ...
    "business_offers": DataServiceEntityInfo(
        factory="business_offers",
        frame_type="offer",
        description="Business-specific offer metrics",
        columns=[
            "office_phone",
            "vertical",
            "spend",
    ...
    "ad_questions": DataServiceEntityInfo(
        factory="ad_questions",
        frame_type="question",
        description="Ad question/form field analytics",
        columns=[
            "office_phone",
            "vertical",
            "question_key",
    ...
    "ad_tests": DataServiceEntityInfo(
        factory="ad_tests",
        frame_type="offer",
        description="A/B test result metrics",
        columns=[
            "office_phone",
            "vertical",
            "spend",
    ...
    "assets": DataServiceEntityInfo(
        factory="assets",
        frame_type="asset",
        description="Creative asset performance metrics",
        columns=[
            "office_phone",
            "vertical",
            "asset_id",
