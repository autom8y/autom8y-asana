...
<!-- KNOSSOS:START borrowed-agents -->
## Borrowed Agents

The following agents are borrowed via `ari rite invoke` (co-seat — the active rite is unchanged):

- **dre**: change-warden, integrity-architect, pipeline-steward, source-load-analyst
- **eunomia**: consolidation-planner, entropy-assessor, pipeline-cartographer, rationalization-executor, test-cartographer, verification-auditor
- **security**: compliance-architect, penetration-tester, security-reviewer, threat-modeler
- **sre**: chaos-engineer, incident-commander, observability-engineer, platform-engineer
<!-- KNOSSOS:END borrowed-agents -->
