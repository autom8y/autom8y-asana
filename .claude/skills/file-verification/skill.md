...
description: "Anti-hallucination verification protocol for file operations. Mandates post-write verification, path anchoring, and explicit failure reporting."
---
...
Execute Write with constructed absolute path:
- Confirm no errors in tool response
- Note if tool reports success or failure
