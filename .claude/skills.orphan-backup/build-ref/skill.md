---
name: build-ref
description: "Implementation-only session from approved TDD. Assumes design exists, produces code and tests. For coding after design approval. Triggers: /build, implement design, code from TDD, build approved design."
---
