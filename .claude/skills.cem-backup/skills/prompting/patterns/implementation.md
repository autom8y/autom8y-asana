...
Available skills:
- `documentation` — TDD/ADR templates
- `standards` — tech stack, code conventions
...
- `documentation` — ADR templates (for implementation decisions)
...
- [standards](../../standards/SKILL.md) - Code conventions and file placement
