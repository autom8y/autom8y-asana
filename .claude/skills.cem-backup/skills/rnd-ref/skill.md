...
name: rnd-ref
description: |
  Reference documentation for Innovation Lab (R&D Pack).
  Use when: learning about rnd-pack agents, understanding the innovation workflow,
  invoking R&D agents. Triggers: rnd-pack, innovation lab, technology-scout,
