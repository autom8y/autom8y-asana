---
name: architect-ref
description: "Design-only session producing TDD and ADRs without implementation. For architectural planning before coding. Triggers: /architect, design session, architecture planning, technical design."
---
