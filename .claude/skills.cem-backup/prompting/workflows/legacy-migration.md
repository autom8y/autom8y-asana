...
- [Discovery](../patterns/discovery.md) - Migration PRD prompts
- [Implementation](../patterns/implementation.md) - Phased implementation
- [Validation](../patterns/validation.md) - Parity validation
