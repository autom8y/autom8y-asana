...
They activate automatically based on your task.)
...
- [Discovery](../patterns/discovery.md) - Add Feature to Existing System prompt
- [Implementation](../patterns/implementation.md) - Design extension patterns
- [Validation](../patterns/validation.md) - Validate against multiple PRDs
