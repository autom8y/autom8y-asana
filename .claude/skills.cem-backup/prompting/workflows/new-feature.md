...
- [Discovery](../patterns/discovery.md) - Session initialization, PRD prompts
- [Implementation](../patterns/implementation.md) - TDD and coding prompts
- [Validation](../patterns/validation.md) - Testing and validation prompts
