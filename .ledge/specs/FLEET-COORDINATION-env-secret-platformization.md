...
- `reclassified-source-of-truth` — satellite is structurally upstream of the fleet contract; authors Layers 1-2 of the canonical env loader (and/or equivalent primitives). Playbook execution structurally inapplicable. Outcome: ADR reclassification + .know/env-loader-source-of-truth.md.
