...
# --- Adversarial tests (merged from test_adversarial_pacing.py; Sprint 15 S4) ---
# ---------------------------------------------------------------------------
# Helpers
# ---------------------------------------------------------------------------
...
class _FakePageIterator_MergedAdv:
...
def _pacing_env(
    ...
    """Context manager that sets pacing env vars and resets settings."""
    env_overrides = {
        "ASANA_PACING_PAGES_PER_PAUSE": str(pace_pages),
        "ASANA_PACING_CHECKPOINT_EVERY_N_PAGES": str(checkpoint_pages),
        "ASANA_PACING_DELAY_SECONDS": str(delay),
    }
...
def _patch_pacing(
    ...
    """Context manager to patch asyncio.sleep and set pacing env vars.
    ...
    return (
        ...
        _pacing_env(pace_pages, checkpoint_pages, delay),
    )
...
class TestSectionSizeBoundaries:
    ...
    async def test_section_with_1_task(self) -> None:
        ...
        builder = _make_builder(manifest=manifest)
        builder._client.tasks.list_async.return_value = _FakePageIterator_MergedAdv(1)
    ...
    async def test_section_with_99_tasks(self) -> None:
        ...
        builder = _make_builder(manifest=manifest)
        builder._client.tasks.list_async.return_value = _FakePageIterator_MergedAdv(99)
    ...
    async def test_section_with_exactly_100_tasks(self) -> None:
        ...
        builder = _make_builder(manifest=manifest)
        builder._client.tasks.list_async.return_value = _FakePageIterator_MergedAdv(100)
    ...
    async def test_section_with_101_tasks(self) -> None:
        ...
        builder = _make_builder(manifest=manifest)
        builder._client.tasks.list_async.return_value = _FakePageIterator_MergedAdv(101)
    ...
    async def test_section_with_10000_tasks(self) -> None:
        ...
        builder = _make_builder(manifest=manifest)
        builder._client.tasks.list_async.return_value = _FakePageIterator_MergedAdv(10000)
...
class TestS3WriteFailureDuringCheckpoint:
    ...
    async def test_s3_checkpoint_failure_continues_fetching(self) -> None:
        ...
        builder._client.tasks.list_async.return_value = _FakePageIterator_MergedAdv(5000)
...
class TestTaskToDictExceptionMidLoop:
    ...
    async def test_task_to_dict_exception_mid_loop(self) -> None:
        ...
        iterator = _FakePageIterator_MergedAdv(200)
...
class TestConcurrentLargeSections:
    ...
    async def test_concurrent_sections_manifest_consistency(self) -> None:
        ...
        builder1._client.tasks.list_async.return_value = _FakePageIterator_MergedAdv(300)
        builder2._client.tasks.list_async.return_value = _FakePageIterator_MergedAdv(500, start_gid=300)
...
class TestResumeEdgeCases:
    ...
    async def test_resume_with_rows_fetched_zero(self) -> None:
        ...
        builder = _make_builder(manifest=manifest)
        builder._client.tasks.list_async.return_value = _FakePageIterator_MergedAdv(50)
    ...
    async def test_resume_section_shrank(self) -> None:
        ...
        builder._client.tasks.list_async.return_value = _FakePageIterator_MergedAdv(200)
...
class TestConfigurationBoundaries:
    ...
    async def test_pace_pages_per_pause_1(self) -> None:
        ...
        builder._client.tasks.list_async.return_value = _FakePageIterator_MergedAdv(300)
...
class TestDataIntegrity:
    ...
    async def test_all_tasks_present_in_final_dataframe(self) -> None:
        ...
        builder._client.tasks.list_async.return_value = _FakePageIterator_MergedAdv(total_tasks)
...
class TestPageBoundaryAccounting:
    ...
    async def test_partial_final_page_counted(self) -> None:
        ...
        builder = _make_builder(manifest=manifest)
        builder._client.tasks.list_async.return_value = _FakePageIterator_MergedAdv(250)
    ...
    async def test_exact_page_multiples(self) -> None:
        ...
        builder = _make_builder(manifest=manifest)
        builder._client.tasks.list_async.return_value = _FakePageIterator_MergedAdv(500)
