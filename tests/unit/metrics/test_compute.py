...
# --- Adversarial tests (merged from test_adversarial.py; Sprint 15 S4) ---
# ---------------------------------------------------------------------------
# Helpers
# ---------------------------------------------------------------------------
...
class TestCLIAdversarial:
    """Adversarial tests for -m", "autom8_asana.metrics CLI."""

    def test_cli_no_args(self) -> None:
        """No arguments -> error exit."""
        result = subprocess.run(
            [sys.executable, "-m", "autom8_asana.metrics"],
            capture_output=True,
            text=True,
            timeout=30,
            cwd=_PROJECT_ROOT,
    ...
    def test_cli_list(self) -> None:
        ...
        result = subprocess.run(
            [sys.executable, "-m", "autom8_asana.metrics", "--list"],
            capture_output=True,
            text=True,
            timeout=30,
            cwd=_PROJECT_ROOT,
    ...
    def test_cli_unknown_metric(self) -> None:
        ...
        result = subprocess.run(
            [sys.executable, "-m", "autom8_asana.metrics", "nonexistent_metric"],
            capture_output=True,
            text=True,
            timeout=30,
            cwd=_PROJECT_ROOT,
    ...
    def test_cli_no_bucket_env(self) -> None:
        ...
        result = subprocess.run(
            [sys.executable, "-m", "autom8_asana.metrics", "active_mrr"],
            capture_output=True,
            text=True,
            timeout=30,
            cwd=_PROJECT_ROOT,
    ...
    def test_cli_help(self) -> None:
        ...
        result = subprocess.run(
            [sys.executable, "-m", "autom8_asana.metrics", "--help"],
            capture_output=True,
            text=True,
            timeout=30,
            cwd=_PROJECT_ROOT,
    ...
    def test_cli_list_and_metric_name(self) -> None:
        ...
        result = subprocess.run(
            [sys.executable, "-m", "autom8_asana.metrics", "--list", "active_mrr"],
            capture_output=True,
            text=True,
            timeout=30,
            cwd=_PROJECT_ROOT,
...
class TestImportSafety:
    ...
    def test_offer_classification_used_correctly(self) -> None:
        """ACTIVE_MRR uses classification='active' instead of section GID."""
        MetricRegistry.reset()
        registry = MetricRegistry()
        mrr = registry.get_metric("active_mrr")
        assert mrr.scope.classification == "active"
        assert mrr.scope.section is None
        MetricRegistry.reset()
