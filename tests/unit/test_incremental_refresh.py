...
class TestRefreshIncrementalNoWatermark:
    ...
    @pytest.mark.asyncio
    async def test_no_watermark_triggers_full_fetch(self) -> None:
    ...
    @pytest.mark.asyncio
    async def test_existing_df_none_with_watermark_triggers_full_fetch(self) -> None:
...
class TestRefreshIncrementalWithWatermark:
    ...
    @pytest.mark.asyncio
    async def test_with_watermark_fetches_modified_only(self) -> None:
    ...
    @pytest.mark.asyncio
    async def test_no_changes_returns_existing_df(self) -> None:
...
class TestMergeDeltas:
    ...
    def test_merge_deltas_replaces_existing_rows(self) -> None:
    ...
    def test_merge_deltas_adds_new_tasks(self) -> None:
    ...
    def test_merge_deltas_empty_changes_returns_existing(self) -> None:
    ...
    def test_merge_deltas_multiple_updates_and_new(self) -> None:
...
class TestFallbackBehavior:
    ...
    @pytest.mark.asyncio
    async def test_error_during_incremental_triggers_full_fetch(self) -> None:
    ...
    @pytest.mark.asyncio
    async def test_future_watermark_triggers_full_rebuild(self) -> None:
...
class TestWatermarkCalculation:
    ...
    @pytest.mark.asyncio
    async def test_new_watermark_is_sync_start_time(self) -> None:
    ...
    @pytest.mark.asyncio
    async def test_watermark_is_timezone_aware(self) -> None:
...
class TestNoProjectGid:
    ...
    @pytest.mark.asyncio
    async def test_no_project_gid_returns_empty_df(self) -> None:
